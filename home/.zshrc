...
__conda_setup="$('/home/wlmeng/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/wlmeng/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/wlmeng/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/wlmeng/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
export MAMBA_EXE='/home/wlmeng/.local/bin/micromamba';
export MAMBA_ROOT_PREFIX='/home/wlmeng/micromamba';
